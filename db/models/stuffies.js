...
async function createStuffiesDatabase(){
    ...
    try {
      const stuffiesToAddToDatabase = [
        ...
        { name: 'Plush Bunny', price: 50, size: 'Large', colors: 'White and Light Blue Pants', imageUrl1: '../models/plush_large_bunny_light_blue_grey.jpg', imageUrl2: ''},
        ...
        { name: 'Plush Witch Hat Frog', price: 6, size: 'Small', colors: 'Green with Light Purple Hat', imageUrl1: '../models/plush_frog_with_witch_hat.jpg', imageUrl2: ''},
        ...
        { name: 'Acrylic Mushroom Boi', price: 6, size: 'Small', colors: 'Red and White', imageUrl1: '../models/acrylic_mushroom_boi.jpg', imageUrl2: ''},
        { name: 'Acrylic Nugget with Hat', price: 6, size: 'Small', colors: 'White with Red Hat', imageUrl1: '../models/acrylic_nugget_with_hat.jpg', imageUrl2: ''},
        ...
        { name: 'Acrylic Coasters', price: 2, size: '', colors: 'Green', imageUrl1: '../models/acrylic_coasters.jpg', imageUrl2: ''},
